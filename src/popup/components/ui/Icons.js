...
const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
        <symbol id="logo" viewBox="0 0 162 18">
            <g transform="translate(125.744)">
                <rect width="36" height="18" fill="#5EB0B7" rx="3" />
                <path fill="#FFF" fillRule="nonzero" d="M7.6784 13.2003c.9688-.0079 1.7149-.2227 2.2383-.6446.5234-.4219.7851-1.043.7851-1.8633 0-.4804-.126-.8867-.3779-1.2187-.252-.332-.5967-.5527-1.0342-.6621.3828-.1485.6817-.3819.8965-.7002.2149-.3184.3223-.6865.3223-1.1045 0-.7656-.2676-1.3467-.8027-1.7432-.5352-.3965-1.3204-.5947-2.3555-.5947H4.362v8.5313h3.3164zm-.2578-4.957H6.1198V6.0927h1.2305c.4844 0 .8388.085 1.0635.255.2246.1698.3369.4482.3369.8349 0 .6914-.4434 1.0449-1.3301 1.0605zm.205 3.5448H6.1199V9.4854h1.6113c.8086.0117 1.213.4082 1.213 1.1895 0 .3476-.1163.62-.3487.8173-.2324.1973-.5557.296-.9697.296zm10.1134 1.4122V11.788h-3.961V9.503h3.375V8.126h-3.375V6.0928h3.9492V4.669h-5.707v8.5313h5.7188zm4.957 0V6.0928h2.6133V4.669H18.36v1.4238h2.5782v7.1075h1.7578zm4.0605 0l.586-1.7579h3.082l.5918 1.7579h1.8691L29.6921 4.669h-1.629l-3.1757 8.5313h1.8691zm3.1934-3.1817H27.817l1.0605-3.1933 1.0723 3.1933z" />
            </g>
